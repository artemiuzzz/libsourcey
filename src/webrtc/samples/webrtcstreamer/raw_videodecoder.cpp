...
RawVideoDecoder::RawVideoDecoder(AVStream* stream)
    : VideoDecoder(stream)
{
}
...
//void RawVideoDecoder::open()
//{
//    VideoContext::open();
//}


//void RawVideoDecoder::close()
//{
//    VideoContext::close();
//}
...
//void RawVideoDecoder::flush() // AVPacket& opacket
//{
//    AVPacket ipacket;
//    av_init_packet(&ipacket);
